...
Now we have the opportunity to select which OUs to sync to Entra Connect. Fill in the bubble **Sync Selected domains and OUs** then expand your domain tree and spcify the OUs to sync. I will be choosing to sync OUs that have user and group objects inside them. Click **Next**
